...
public class StringUtils {
    ...
    public static String MD5(String decript) {
        try {
            ...
            Log.e("StringUtil.MD5", "decript:" + decript, e);
        }
        return null;
    }
    ...
    public static String getColorStr(String text, String color) {
        StringBuffer buffer = new StringBuffer();
        String prefix = "<font color=\"%s\">";
        prefix = String.format(prefix, color);
        String endfix = "</font>";
        buffer.append(prefix);
        buffer.append(text);
        buffer.append(endfix);
